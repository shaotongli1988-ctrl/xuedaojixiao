...
- Generated At: 2026-04-19T06:43:23.951Z
...
- Step 1: screenshot -> passed
  File: tasks/artifacts/admin-office-ledgers-gui-18300/admin-office-vehicle-hr-diagnose.png
...
- Step 1: screenshot -> passed
  File: tasks/artifacts/admin-office-ledgers-gui-18300/admin-office-ip-hr-diagnose.png
- Step 2: waitBodyText -> passed
- Step 3: assertVisibleText -> failed
  Error: assertVisibleText failed: includes=["知识产权管理","新增知识产权","编号 / 标题","类型","状态"] excludes=[]
...
- Step 3: screenshot -> passed
  File: tasks/artifacts/admin-office-ledgers-gui-18300/admin-office-manager-no-entry.png
...
- Step 2: assertVisibleText -> passed
- Step 3: screenshot -> passed
  File: tasks/artifacts/admin-office-ledgers-gui-18300/admin-office-employee-no-entry.png
