			...
			<el-row :gutter="16">
				<el-col :xs="24" :md="12">
					<el-card shadow="never" class="teacher-channel-todo-page__summary-card">
						...
						<div class="teacher-channel-todo-page__summary-value">
							{{ bucketSummary.today }}
						</div>
					</el-card>
				</el-col>
				<el-col :xs="24" :md="12">
					<el-card shadow="never" class="teacher-channel-todo-page__summary-card">
						...
						<div
							class="teacher-channel-todo-page__summary-value teacher-channel-todo-page__summary-value--danger"
						>
