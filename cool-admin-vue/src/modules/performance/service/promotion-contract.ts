...
function decodePromotionReviewRecord(
	...
	return {
		...
		promotionId: expectPerformanceServiceOptionalNumber(record.promotionId, `${field}.promotionId`),
		reviewerId: expectPerformanceServiceOptionalNumber(record.reviewerId, `${field}.reviewerId`) ?? 0,
		reviewerName: expectPerformanceServiceOptionalString(record.reviewerName, `${field}.reviewerName`),
...
export function decodePromotionRecord(
	value: unknown,
	field = 'promotionRecord'
): PromotionRecord {
	const record = expectPerformanceServiceRecord(value, field);
	...
	return {
		...
		sponsorName: expectPerformanceServiceOptionalString(record.sponsorName, `${field}.sponsorName`),
		...
		reviewTime: expectPerformanceServiceOptionalString(record.reviewTime, `${field}.reviewTime`),
		assessmentId:
