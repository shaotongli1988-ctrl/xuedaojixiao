...
import { createApp, onActivated, onDeactivated } from "vue/dist/vue.runtime.esm-bundler.js";
 ...
 */
export function injectHook(type: string, hook: HookHandler, target?: HookTarget, prepend = false) {
